...
(写真)
(再掲) 見よこのサイズ感！ PS5 (初期型) と比べても小さいのに遥かに高性能
...
さっきの写真をよく見るとわかるが、グラボがケースに対して水平になっておらず、ケース前面側が微妙に下がってしまっている。4080 FE がかなり重いにもかかわらず、それを支えるのが PCIe の接続部分と背面の IO ブラケットのネジ留めだけで、前面側に支えが何もないためどうしてもこうなってしまうようだ。せっかくの美観が損なわれていて残念だし、組み立て直後でこれなら数年後にはもっとひどくなっているんじゃないかと心配になる。

もう一つは、CPU 側のサイドパネルが微妙に閉まりきっていないこと。電源ユニットがケース幅をはみ出して邪魔をしているように見える。一応原因には心当たりがある[^side-panel]ので直したいが、見てのとおり内部がギチギチであるゆえに取り付け直すには先にいろんなものを外さねばならず、ちょっと面倒で放置してしまっている。
